"""Create a song on Suno - with CAPTCHA handling."""
import asyncio
import sys
import os
...
Signal in the noise"""
    ...
    if r.success:
        ...
        await browser.screenshot("/tmp/suno_skills/song_created.png")
        print("Screenshot saved to /tmp/suno_skills/song_created.png")

    # Keep browser open for a bit so user can see
    print("\nBrowser staying open for 30s so you can verify...")
